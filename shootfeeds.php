...
$sqlef=mysqli_query($super,"SELECT count(idd) FROM `textfind` WHERE  time1>='".$feedlimit."' AND  MATCH(tags)  AGAINST( '".$xtra5."' IN NATURAL LANGUAGE MODE) LIMIT 2000");}

else if($gringo == 4){
$sqlef=mysqli_query($super,"SELECT count(idd) FROM `textfind` WHERE  time1>='".$feedlimit."'   AND tup LIKE '$xtra5%'   LIMIT 2000  ");}
...
//////////if clickmemeberfrompostwasactivatedbyhistory
 ...
 ////page getting num rows
      ...
      if($datacount == 0){  }
      $dato=$datacount;
  $pager=25; ///page number of results to be showm
           ...
           $("#topbar").show();
            ...
            wt.style.visibility="visible";
             document.getElementById("wideposttotalin").innerHTML="'.$datacount.'";
                 ...
                 if($gringo == 3 ||  $gringo== 4){
              echo '<script> 
          
        document.getElementById("feedsholder").innerHTML="'.$xtra5.'";
...
<div id="superpostdatago'.$pagenum.''.$gringo.'" class="col-xs-12  "  style="padding:0px;">
...
if($gringo == 1){
 ...
 $pik="SELECT wall.id,member.name,member.user, member.cl,member.imname, wall.num,wall.cap,wall.tup,wall.time1,wall.count,wall.sim1,wall.sim1ty,wall.sim2,wall.sim2ty,wall.sim3,wall.sim3ty,wall.sim4,wall.sim4ty,wall.sim5,wall.sim5ty,wall.sim6,wall.sim6ty,wall.sim7,wall.sim7ty,wall.sim8,wall.sim8ty,wall.sim9,wall.sim9ty,wall.sim10,wall.sim10ty,wall.sim11,wall.sim11ty,wall.sim12,wall.sim12ty,wall.sim13,wall.sim13ty,wall.sim14,wall.sim14ty,wall.sim15,wall.sim15ty,wall.sim16,wall.sim16ty FROM wall,member  WHERE  member.num='".$d."'  AND  member.num=wall.num  AND time1>='".$feedlimit."'   AND id<='".$feedlock."'    ORDER BY id DESC $limit";}
  ...
  $piko= mysqli_query($super,"SELECT id FROM `textfind` WHERE  time1>='".$feedlimit."' AND  MATCH(tags)  AGAINST('".$xtra5."' IN NATURAL LANGUAGE MODE) ORDER BY idd DESC $limit ");
   while($row=mysqli_fetch_array($piko)){
  array_push($fali,$row['id']); }}
   else if($gringo == 4){
$piko=mysqli_query($super,"SELECT  id FROM `textfind` WHERE  time1>='".$feedlimit."'   AND tup LIKE '$xtra5%'  ORDER BY idd 
  DESC $limit  "); 
 while($row=mysqli_fetch_array($piko)){
  array_push($fali,$row['id']); }}
      ...
      array_push($fasm16ty,$row['sim16ty']);
       if($feedcounter==0 && $jump == 0 ){  $idlock=$favi[0];  }
        ...
        ///selecting information for supertarz all feeds 
         ...
         else if($gringo == 3 || $gringo == 4){ 

         $lan=count($fali);

     $pik="SELECT wall.id,member.name,member.user, member.cl,member.imname, wall.num,wall.cap,wall.tup,wall.time1,wall.count,wall.sim1,wall.sim1ty,wall.sim2,wall.sim2ty,wall.sim3,wall.sim3ty,wall.sim4,wall.sim4ty,wall.sim5,wall.sim5ty,wall.sim6,wall.sim6ty,wall.sim7,wall.sim7ty,wall.sim8,wall.sim8ty,wall.sim9,wall.sim9ty,wall.sim10,wall.sim10ty,wall.sim11,wall.sim11ty,wall.sim12,wall.sim12ty,wall.sim13,wall.sim13ty,wall.sim14,wall.sim14ty,wall.sim15,wall.sim15ty,wall.sim16,wall.sim16ty FROM wall,member  WHERE  wall.id=?  AND  member.num=wall.num  AND time1>='".$feedlimit."'   AND id<='".$feedlock."'    ORDER BY id DESC $limit";

         ///selecting information for supertarz all feeds 
        $selfeedinfo=$pik; 
    $feedpack= $super->prepare($selfeedinfo);
     $feedpack->bind_param("i",$rx);
...
$activepad1="emodeactivex";
$activepad2="emodeactivex";
$activepad3="emodeactivex";
$activepad4="emodeactivex";
...
if($feelstate == 1){ 
   $activepad1="emoactivekey1x";  $activepad1z="28";    $act1=$myemotion;  $act1x='hightext'.$ivd.''.$gringo.'';  $act1y="";}
else if($feelstate == 2){ 
   $activepad2="emoactivekey2x"; $act2=$myemotion;   $activepad2z="28";  $act2x='hightext'.$ivd.''.$gringo.'';    $act2y="";}
else if($feelstate == 3){
    $activepad3="emoactivekey3x";  $act3=$myemotion;  $activepad3z="28";  $act3x='hightext'.$ivd.''.$gringo.'';  $act3y="";}
else if($feelstate == 4){
    $activepad4="emoactivekey4x";  $act4=$myemotion;   $activepad4z="28";  $act4x='hightext'.$ivd.''.$gringo.'';  $act4y="";}
...
if($totalsets == 1){ $infoicon=""; }else{
 ...
 if($sim1 != " "){  
if($sim1ty == 0){  
$set1=' <div data-index="1"   class="col-xs-12  carousel-cell"   style="outline:none;padding:0px;'.$timh1.';">
<img src="images/thumb/thumb'.$sim1.'"  class="blurplaceholder"    id="thumb1'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims1.'="images/wall/'.$sim1.'"  class="zuzax  firstim   "  id="image1'.$ivd.''.$gringo.'" 
  onmousedown="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  style="position:relative;padding:0px;'.$timv1.'"  height="auto" width="100%" />
        </div>';  }
    else{
 ...
 $sim1hot=hashtagplayx($sim1,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim1hot=usertagplayx($sim1hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set1='
<div  data-index="1"  style="outline:none;"  class="carousel-cell">
<div  id="image1'.$ivd.''.$gringo.'"  onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);" class="zuzax  '.$texttheme1.'   "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px;">
<div  id="image1inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px;"><mando  style="opacity:0.95"  class="smoothfont">
...
echo '<script>sizetextitem("'.$sim1.'","image1inside'.$ivd.''.$gringo.'","image1'.$ivd.''.$gringo.'");</script>';}}
       ...
       if($sim2 != " "){  
     if($sim2ty == 0){  
$set2=' <div data-index="2" class="col-xs-12  carousel-cell " style="outline:none;padding:0px;'.$timh2.'">
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim2.'"  class="blurplaceholder"    id="thumb2'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims2.'="images/wall/'.$sim2.'"  class="zuzax "  id="image2'.$ivd.''.$gringo.'" 
  onmousedown="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  style="position:relative;border-radius:0px;padding:0px;'.$timv2.'"  height="auto" width="100%" />
         </div> </div>'; }
         else{
 ...
 $sim2hot=hashtagplayx($sim2,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);  
 $sim2hot=usertagplayx($sim2hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set2='
<div  data-index="2"  style="outline:none;"   class="carousel-cell">
<div  id="image2'.$ivd.''.$gringo.'"   onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme2.' superpocket'.$pagenum.'   "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image2inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px;font-weight:400"><mando style="opacity:0.95" class="smoothfont">
...
echo '<script>sizetextitem("'.$sim2.'","image2inside'.$ivd.''.$gringo.'","image2'.$ivd.''.$gringo.'");</script>';}}
     ...
     if($sim3 != " "){  
      if($sim3ty == 0){  
$set3=' <div  data-index="3"  class="col-xs-12  carousel-cell" style="outline:none;padding:0px;'.$timh3.'">
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim3.'"  class="blurplaceholder"    id="thumb3'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims3.'="images/wall/'.$sim3.'"  class="zuzax"  id="image3'.$ivd.''.$gringo.'" 
 ...
 $sim3hot=hashtagplayx($sim3,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim3hot=usertagplayx($sim3hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set3='
<div  data-index="3"  style="outline:none;"  class="carousel-cell">
<div  id="image3'.$ivd.''.$gringo.'"   onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme3.'
superpocket'.$pagenum.' "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image3inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim4.'"  class="blurplaceholder"    id="thumb4'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims4.'="images/wall/'.$sim4.'"  class="zuzax"  id="image4'.$ivd.''.$gringo.'" 
 ...
 $sim4hot=hashtagplayx($sim4,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim4hot=usertagplayx($sim4hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set4='
<div  data-index="4"  style="outline:none;">
<div  id="image4'.$ivd.''.$gringo.'"  onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme4.'
superpocket'.$pagenum.' "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image4inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim5.'"  class="blurplaceholder"    id="thumb5'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims5.'="images/wall/'.$sim5.'"  class="zuzax"  id="image5'.$ivd.''.$gringo.'" 
 ...
 $sim5hot=hashtagplayx($sim5,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim5hot=usertagplayx($sim5hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set5='
<div  data-index="5"  style="outline:none;">
<div  id="image5'.$ivd.''.$gringo.'"   onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme5.' superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image5inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
'.$sim5hot.'</mando></div> </div> </div>';
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim6.'"  class="blurplaceholder"    id="thumb6'.$ivd.''.$gringo.'"  style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims6.'="images/wall/'.$sim6.'"  class="zuzax   "  id="image6'.$ivd.''.$gringo.'" 
 ...
 $sim6hot=hashtagplayx($sim6,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim6hot=usertagplayx($sim6hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set6='
<div  data-index="6"  style="outline:none;">
<div  id="image6'.$ivd.''.$gringo.'"  onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"    class="zuzax  '.$texttheme6.'
superpocket'.$pagenum.'   "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image6inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95"  class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim7.'"  class="blurplaceholder"    id="thumb7'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims7.'="images/wall/'.$sim7.'"  class="zuzax   "  id="image7'.$ivd.''.$gringo.'" 
...
style="position:relative;border-radius:0px;padding:0px;'.$timv7.'"  height="auto" width="100%" />
 ...
 $sim7hot=hashtagplayx($sim7,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim7hot=usertagplayx($sim7hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set7='
<div  data-index="7"  style="outline:none;">
<div  id="image7'.$ivd.''.$gringo.'"   onclick="javascript:zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme7.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image7inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando  style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim8.'"  class="blurplaceholder"    id="thumb8'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims8.'="images/wall/'.$sim8.'"  class="zuzax    "  id="image8'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv8.'"  height="auto" width="100%" />
 ...
 $sim8hot=hashtagplayx($sim8,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim8hot=usertagplayx($sim8hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set8='
<div  data-index="8"  style="outline:none;">
<div  id="image8'.$ivd.''.$gringo.'"   onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme8.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image8inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img src="images/thumb/thumb'.$sim9.'"  class="blurplaceholder"    id="thumb9'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims9.'="images/wall/'.$sim9.'"  class="zuzax   "  id="image9'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv9.'"  height="auto" width="100%" />
 ...
 $sim9hot=hashtagplayx($sim9,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim9hot=usertagplayx($sim9hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set9='
<div  data-index="9"  style="outline:none;">
<div  id="image9'.$ivd.''.$gringo.'"   onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"   class="zuzax  '.$texttheme9.'
superpocket'.$pagenum.' "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image9inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95"  class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim10.'"  class="blurplaceholder"    id="thumb10'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims10.'="images/wall/'.$sim10.'"  class="zuzax  "  id="image10'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv10.'"  height="auto" width="100%" />
 ...
 $sim10hot=hashtagplayx($sim10,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim10hot=usertagplayx($sim10hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set10='
<div  data-index="10"  style="outline:none;">
<div  id="image10'.$ivd.''.$gringo.'"  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme10.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image10inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim11.'"  class="blurplaceholder"    id="thumb11'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims11.'="images/wall/'.$sim11.'"  class="zuzax   "  id="image11'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv11.'"  height="auto" width="100%" />
 ...
 $sim11hot=hashtagplayx($sim11,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim11hot=usertagplayx($sim11hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set11='
<div  data-index="11"  style="outline:none;">
<div  id="image11'.$ivd.''.$gringo.'"  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme11.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image11inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim12.'"  class="blurplaceholder"    id="thumb12'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims12.'="images/wall/'.$sim12.'"  class="zuzax   "  id="image12'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv12.'"  height="auto" width="100%" />
 ...
 $sim12hot=hashtagplayx($sim12,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim12hot=usertagplayx($sim12hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set12='
<div  data-index="12"  style="outline:none;">
<div  id="image12'.$ivd.''.$gringo.'"   onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);" class="zuzax  '.$texttheme12.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image12inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95"  class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim13.'"  class="blurplaceholder"    id="thumb13'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims13.'="images/wall/'.$sim13.'"  class="zuzax   "  id="image13'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv13.'"  height="auto" width="100%" />
 ...
 $sim13hot=hashtagplayx($sim13,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim13hot=usertagplayx($sim13hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set13='
<div  data-index="13"  style="outline:none;">
<div  id="image13'.$ivd.''.$gringo.'"  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme13.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image13inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando  style="opacity:0.95"  class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim14.'"  class="blurplaceholder"    id="thumb14'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims14.'="images/wall/'.$sim14.'"  class="zuzax   "  id="image14'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv14.'"  height="auto" width="100%" />
 ...
 $sim14hot=hashtagplayx($sim14,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim14hot=usertagplayx($sim14hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set14='
<div  data-index="14"  style="outline:none;">
<div  id="image14'.$ivd.''.$gringo.'"   onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);" class="zuzax  '.$texttheme14.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image14inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando  style="opacity:0.95"  class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim15.'"  class="blurplaceholder"    id="thumb15'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims15.'="images/wall/'.$sim15.'"  class="zuzax   "  id="image15'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv15.'"  height="auto" width="100%" />
 ...
 $sim15hot=hashtagplayx($sim15,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim15hot=usertagplayx($sim15hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set15='
<div  data-index="15"  style="outline:none;">
<div  id="image15'.$ivd.''.$gringo.'"  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme15.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:6px;justify-content:center;height:0px">
<div  id="image15inside'.$ivd.''.$gringo.'"  style="padding:0px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
...
<div class="superpocket'.$pagenum.'">
<img  src="images/thumb/thumb'.$sim16.'"  class="blurplaceholder"    id="thumb16'.$ivd.''.$gringo.'"  
style="position:absolute;border-radius:0px;padding:0px;margin-left:0.5%"  height="auto" width="99%" />
<img  '.$tims16.'="images/wall/'.$sim16.'"  class="zuzax   "  id="image16'.$ivd.''.$gringo.'" 
  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  
style="position:relative;border-radius:0px;padding:0px;'.$timv16.'"  height="auto" width="100%" />
 ...
 $sim16hot=hashtagplayx($sim16,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5);
 $sim16hot=usertagplayx($sim16hot,$ivd,$gringo,$userid,$puser,$idlock,$pagenum,$ivd,$d,$name,$gringo,$xtra5,$pim,$pcl);
$set16='
<div  data-index="16"  style="outline:none;">
<div  id="image16'.$ivd.''.$gringo.'"  onclick="javascript: zoominshortimages'.$ivd.''.$pagenum.''.$gringo.'(0,0,0);"  class="zuzax  '.$texttheme16.'
superpocket'.$pagenum.'  "   
style="padding:0px;text-align:center;overflow:auto;border-radius:0px;justify-content:center;height:0px">
<div  id="image16inside'.$ivd.''.$gringo.'"  style="padding:6px;text-align:center;height:auto;font-size:0px"><mando style="opacity:0.95" class="smoothfont">
